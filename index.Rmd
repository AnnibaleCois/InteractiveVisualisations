...
--
<img src = "images/arrow_1.png" style = "width: 20%; position: absolute; margin-top: 16.5%; margin-left: 9.5%; transform: rotate(-20deg);"></img>

--
<img src = "images/circle.png" style = "width: 30%; position: absolute; margin-top: 18%; margin-left: 40%; "></img>

---
class: hide_logo
background-image: url("images/ofg_2.png")
background-position: 50% 50%
background-size: 60%

--
<img src = "images/ofg_3.png" style = "width: 50%; position: relative; margin-top: 10%; margin-left: 25%;"></img>
...
.center[*Download the example dataset*]

.footnote[.large[.center[
<img src = "images/github.png" width = "85"></img> <br/><br/>
Links: <a href="https://annibalecois.github.io/InteractiveVisualisations/code/cvd/cvd.RData" download>https://annibalecois.github.io/InteractiveVisualisations/code/cvd/cvd.RData</a>
]]]
---
<br/>
<br/>
...
--
<img src = "images/arrow_1.png" style = "width: 20%; position: absolute; margin-top: 3%; margin-left: 15%; transform: rotate(-20deg"></img>

--
<img src = "images/arrow_1.png" style = "width: 20%; position: absolute; margin-top: 20%; margin-left: 5%; transform: rotate(-170deg"></img>

--
<img src = "images/arrow_1.png" style = "width: 20%; position: absolute; margin-top: 20%; margin-left: 30%; transform: rotate(0deg"></img>
